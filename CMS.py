...
CMS_LOGIN_URL = "https://test.genexcms.com/CMS/Login.aspx"
CMS_CASESEARCH_URL = "https://test.genexcms.com/CMS/CaseSearch.aspx"
 
EDGE_PATH = r"C:\Program Files (x86)\Microsoft\Edge\Application\msedge.exe"
IE_DRIVER_PATH = r"D:\Users\KC133062\Documents\AutoHotkey\IEDriverServer.exe"
...
def CheckCaseUnity(claim_number):
    ...
    def create_driver():
        EDGE_DRIVER_PATH = r"D:\Users\KC133062\Documents\AutoHotkey\msedgedriver.exe"
        opts = EdgeOptions()
...
if __name__ == "__main__":
    ...
    conn_str = (
        ...
        "DATABASE=RRS;"
        "UID=RRSApplication;"
        "PWD=9OnR!vFsx$qr4rx*pv;"
    )
 
    run_case(
        connection_string=conn_str,
        claimant_name="Kirsten Lark",
        claim_number="WC555N69233",
        cms_user="mcarag",
        cms_pass="Patil!23",
